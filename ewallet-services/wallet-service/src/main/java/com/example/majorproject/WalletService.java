...
public class WalletService {
    ...
    public void createWallet(String message) throws JsonProcessingException, JSONException {
    ...
    public void updateWallet(String message) throws JsonProcessingException, JSONException {
